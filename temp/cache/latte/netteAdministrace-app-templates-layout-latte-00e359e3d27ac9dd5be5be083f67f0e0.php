<?php
// source: G:\xampp\htdocs\netteAdministrace\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1147533788', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbbe98cbbc3f_head')) { function _lbbe98cbbc3f_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbe226b8a288_scripts')) { function _lbe226b8a288_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
