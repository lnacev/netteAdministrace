<?php
// source: G:\xampp\htdocs\netteAdministrace\app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5621929284', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbbae85160b8_content')) { function _lbbae85160b8_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<div id="content">
	...
	<section id="presenter">
		<h2>Current presenter located at <span><?php echo Latte\Runtime\Filters::escapeHtml(strstr($presenter->reflection->fileName, 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush-php"><?php echo Latte\Runtime\Filters::escapeHtml(file_get_contents($presenter->reflection->fileName), ENT_NOQUOTES) ?></code></pre>
	</section>
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbf10132e42b_title')) { function _lbf10132e42b_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbfec47f9e24_scripts')) { function _lbfec47f9e24_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lba879db44df_head')) { function _lba879db44df_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
